...
class GME_Modules_Attribute_FlybyHeight : SCR_BaseValueListEditorAttribute
{
	//------------------------------------------------------------------------------------------------
	override SCR_BaseEditorAttributeVar ReadVariable(Managed item, SCR_AttributesManagerEditorComponent manager)
	{
		...
		return SCR_BaseEditorAttributeVar.CreateFloat(module.GetHeight());
	}
